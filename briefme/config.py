...
try:
    ...
    if not os.path.exists(feeds_file):
        ...
        feeds_file = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'feeds.yaml')
...
- The summary will be inserted into an HTML template for email as a <div> element
...
- Only include articles:
    ...
    - Published within the last {MAX_AGE_HOURS} hours (ignore older articles)
...
- Do not alter the template, only add the summary content in the [SUMMARIES] placeholder.
