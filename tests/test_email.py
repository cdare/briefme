...
def test_send_email_success(mock_smtp):
    ...
    with patch("briefme.main.EMAIL_FROM", "from@example.com"), patch(
        "briefme.main.EMAIL_TO", "to@example.com"
    ), patch("briefme.main.EMAIL_PASSWORD", "password"), patch(
        "briefme.main.SMTP_SERVER", "smtp.example.com"
    ), patch(
        "briefme.main.SMTP_PORT", 465
    ):
